...
*   **`AI_TEMPERATURE`**: The temperature for your model to reply with, higher values are more creative but hallucinate more. 0.8-1.2 is recommended to start
*   **`AI_MAX_TOKENS`**: The maximum amount of tokens to use whilst replying. Useful if you want to ensure you arnt accidentalyl burning tokens  
